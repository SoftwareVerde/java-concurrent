...
public class CachedThreadPool implements MutableThreadPool {
    ...
    /**
     * Returns the number of threads that are currently in the threadpool.
     */
    ...
    /**
     * Returns the number of tasks that are pending in the thread threadpool, but are not currently being executed.
     */
